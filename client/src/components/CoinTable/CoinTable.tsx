...
export default function CoinTable({ coinList }: CoinTableProps) {
						...
						<th>
							<div className={styles.columnName__withSort}>
								<input
									...
									onClick={() =>
										changeSortType(CoinListSortType.rank)
									}
								/>
								<label
						...
						<th>
							<div className={styles.columnName__withSort}>
								<input
									...
									onClick={() =>
										changeSortType(
											CoinListSortType.changePercent24Hr
										)
									}
								/>
								<label
									htmlFor={CoinListSortType.changePercent24Hr}
								>
