                ...
                case 2:
                    ...
                    coinList = dataInfo.data.map(function (storageCoin) {
                        ...
                        var coin = {
                            ...
                            supply: (0, helper_1.formatSupply)(Number(storageCoin.supply), storageCoin.symbol),
                            maxSupply: (0, helper_1.formatSupply)(Number(maxSupply), storageCoin.symbol),
                            marketCapUsd: (0, helper_1.formatMarketCap)(Number(storageCoin.marketCapUsd)),
                            volumeUsd24Hr: (0, helper_1.formatVolumeUsd24Hr)(Number(storageCoin.volumeUsd24Hr)),
            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    coin = {
                        ...
                        name: storageCoin.name,
                        supply: (0, helper_1.formatSupply)(Number(storageCoin.supply), storageCoin.symbol),
                        maxSupply: (0, helper_1.formatSupply)(Number(storageCoin.maxSupply), storageCoin.symbol),
                        marketCapUsd: (0, helper_1.formatMarketCap)(Number(storageCoin.marketCapUsd)),
                        volumeUsd24Hr: (0, helper_1.formatVolumeUsd24Hr)(Number(storageCoin.volumeUsd24Hr)),
                        priceUsd: (0, helper_1.formatPrice)(storageCoin.priceUsd),
                        changePercent24Hr: (0, helper_1.formatPercent)(storageCoin.changePercent24Hr),
