  ...
  switch (sortType) {
    case CoinListSortType.priceUsd:
      return coinList.sort((a, b) =>
        getUnformattedPrice(a.priceUsd) > getUnformattedPrice(b.priceUsd)
          ? placementFlag
          : -placementFlag,
      );
    case CoinListSortType.marketCapUsd:
      return coinList.sort((a, b) =>
        getUnformattedPrice(a.marketCapUsd) >
        getUnformattedPrice(b.marketCapUsd)
          ? placementFlag
          : -placementFlag,
      );
    case CoinListSortType.changePercent24Hr:
      return coinList.sort((a, b) =>
        getUnformattedPercent(a.changePercent24Hr) >=
        getUnformattedPercent(b.changePercent24Hr)
          ? placementFlag
          : -placementFlag,
      );
